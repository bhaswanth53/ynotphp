    ...
    class Validation {
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = 'Field '.$this->name.' value is less than the minimum value';
                }
            }else{
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'Field '.$this->name.' value is greater then maximum value';
                }
            }else{
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[] = 'Field values '.$this->name.' are not matching.';
            }
            return $this;
        ...
        public function maxSize($size){
            ...
            if($this->file['error'] != 4 && $this->file['size'] > $size){
                $this->errors[] = 'The file '.$this->name.' exceds the maximum size of '.number_format($size / 1048576, 2).' MB.';
            }
            return $this;
